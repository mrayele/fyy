...
class Booking(db.Model):
  id = db.Column(db.Integer, primary_key=True)
  show_id = db.Column(db.Integer, db.ForeignKey('showl.id'), nullable=False)
...
def format_datetime(value, format='medium'):
  date = dateutil.parser.parse(value) # !! research this 
  if format == 'full':
...
app.jinja_env.filters['datetime'] = format_datetime # !! research this
